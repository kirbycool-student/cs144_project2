...
select count(*) from (select distinct u.UserId from User u join Item i on u.UserId = i.Seller where u.location = 'New York' collate latin1_bin) as t;
...
select t.ItemId from (select i.ItemId, b.Amount from Item i join Bid b on i.ItemId = b.ItemId where i.Ends > '2001-12-20 00:00:01' order by b.amount desc limit 1) as t;
