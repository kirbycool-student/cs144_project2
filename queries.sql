...
select t.ItemId from (select i.ItemId, b.Amount from Item i join Bid b on i.ItemId = b.BidId where i.Ends > '2001-12-20 00:00:01' order by b.amount desc limit 1) as t;
